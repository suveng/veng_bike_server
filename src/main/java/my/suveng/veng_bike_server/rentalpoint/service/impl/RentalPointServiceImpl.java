...
public class RentalPointServiceImpl implements RentalPointService {
     ...
     */
    @Override
    public void save(RentalPointMongo rentalPointMongo) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            mongoVe.setPointid(rentalPointMongo.getId());
            vehicle.setPointid(rentalPointMongo.getId());
    ...
    @Override
    public boolean update(RentalPoint rentalPointMysql) {
        return rentalPointMapper.updateByPrimaryKeySelective(rentalPointMysql) >= 1;
